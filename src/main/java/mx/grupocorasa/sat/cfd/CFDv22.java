...
public final class CFDv22 extends CFDv2 {

    private final String XSLT = "/xslt/cfd/2/cadenaoriginal_2_2/cadenaoriginal_2_2.xslt";
    ...
    public CFDv22(InputStream in) throws Exception {
        this.document = (Comprobante) load(in);
        this.context = getContext(document);
    }

    public CFDv22(Comprobante comprobante) throws Exception {
